...
`ecies` class provide:
- Fragement Key encryption:`ECIESEncrypt(pb ecies.PublicKey, ptt []byte) `
- Fragement Key decryption:`ECIESDecrypt(prv *ecies.PrivateKey, ctt []byte, nonce []byte, rb secp256k1.G1Affine)`

## Use Case
- single proof:`Test_ECIES_Circuit` and `TestECIESByMPC`
- Batch proof:`TestBatchEncryptionByMPC`
