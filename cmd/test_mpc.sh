...
go run mpccmd.go export innerSeal --srs srs_2 --beacon test --inner-ccs inner_ccs_ --inner-pk inner_pk_ --inner-vk inner_vk_
go run mpccmd.go export outerSeal --srs srs_2 --beacon test --inner-ccs inner_ccs_ --inner-pk inner_pk_ --inner-vk inner_vk_